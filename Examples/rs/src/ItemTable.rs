...
{
  #[allow(dead_code)]
  pub fn readStream(reader: &mut binary_reader::BinaryReader) -> Vec<Item> {
    std::iter::repeat(reader.read_i32().unwrap()).map(|_|
    Item {
...
{
  #[allow(dead_code)]
  pub fn readStream(reader: &mut binary_reader::BinaryReader) -> Vec<ItemEffect> {
    std::iter::repeat(reader.read_i32().unwrap()).map(|_|
    ItemEffect {
...
{
  #[allow(dead_code)]
  pub fn readStream(reader: &mut binary_reader::BinaryReader) -> Vec<ItemEnchant> {
    std::iter::repeat(reader.read_i32().unwrap()).map(|_|
    ItemEnchant {
      Index: reader.read_i32().unwrap(),
      Item_ID: reader.read_i32().unwrap(),
...
{
  #[allow(dead_code)]
  pub fn readStream(reader: &mut binary_reader::BinaryReader) -> Vec<ItemManufacture> {
    std::iter::repeat(reader.read_i32().unwrap()).map(|_|
    ItemManufacture {
      Index: reader.read_i32().unwrap(),
...
{
  #[allow(dead_code)]
  pub fn readStream(reader: &mut binary_reader::BinaryReader) -> Vec<RandomBoxGroup> {
    std::iter::repeat(reader.read_i32().unwrap()).map(|_|
    RandomBoxGroup {
